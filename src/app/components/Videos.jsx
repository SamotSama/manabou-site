    ...
    return (
      <div className="mx-auto text-gray-700">
        ...
        <div className="flex justify-center py-8 items-center animate-fade-down animate-once animate-duration-[3000ms]">
          <YouTube videoId="MYnjT0xZvsk" opts={opts} onReady={this._onReady} className="shadow-xl shadow-gray-700"/>
        </div>
        <h3 className="text-3xl font-semibold py-8 text-center">
          Yuyu Nihongo / Clases de Japonés - Youtube
        </h3>
        <div className="flex justify-center py-8 items-center animate-fade-down animate-once animate-duration-[3000ms]">
          <YouTube videoId="qcd2zldqYVw" opts={opts} onReady={this._onReady} className="shadow-xl shadow-gray-700"/>
        </div>
		<h3 className="text-3xl font-semibold py-8 text-center">
          Japonés con Junpei / Japonés desde 0 - Youtube
        </h3>
        <div className="flex justify-center py-8 items-center animate-fade-down animate-once animate-duration-[3000ms]">
          <YouTube videoId="Ogz_IkKlvIA" opts={opts} onReady={this._onReady} className="shadow-xl shadow-gray-700"/>
        </div> 
      </div>
    );
  }
